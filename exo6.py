...
from PyQt6.QtWidgets import QApplication, QWidget, QVBoxLayout, QGridLayout, QPushButton, QLabel, QLineEdit, QMessageBox
import socket
import threading
    ...
    def appliquer(self):
        try:
            if self.socket_server:
                ...
                raise Exception("Le socket n'est pas connecté.")
...
def server_function():
    ...
    try:
        ...
        print(f"Erreur lors de la connexion au client : {e}")
